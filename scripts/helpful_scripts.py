...
def get_contract(contract_name):
    ...
    if defined, otherwose, it will deploy a mock version of that contract, and 
    return thar mock contract.

        Args:
            contract_name (string)

        Returns:
            brownie.network.contract.ProjectConract: The most recently deployed
...
def deploy_mocks():
    ...
    account=get_account(decimals=DECIMALS, initial_value=INITIAL_VALUE)
